...
public class Constants {
    ...
    public static final String PARAMS_SEASON_NUMBER = "season_number";
    ...
    // Movie Card Region
    public static final int CARD_TYPE_VERTICAL = 0;
    ...
    // Keys region
    public static final String KEY_WHAT_OPEN = "what_open";

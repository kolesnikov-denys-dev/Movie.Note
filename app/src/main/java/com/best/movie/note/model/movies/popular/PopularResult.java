...
public class PopularResult extends BaseObservable implements Parcelable  {
    ...
    public final static Creator<PopularResult> CREATOR = new Creator<PopularResult>() {
        @SuppressWarnings({
                "unchecked"
        })
